      ...
      submenu: [
        {
          title: 'Client',
          bullet: 'dot',
          page: '/dispatcher/client',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/client/new',
            },
            {
              title: 'Liste',
              page: '/dispatcher/client/list'
            },
          ]},
        {
          title: 'Commande',
          bullet: 'dot',
          page: '/dispatcher/command',
          submenu: [
            {
              title: 'Nouvelle',
              bullet: 'dot',
              page: '/dispatcher/command/new'
            },
            {
              title: 'Liste',
              bullet: 'dot',
              page: '/dispatcher/command/list'
            },
          ]},
        {
          title: 'Produit',
          bullet: 'dot',
          page: '/dispatcher/product',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/product/new'
            },
            {
              title: 'Liste',
              page: '/dispatcher/product/list'
            },
          ]},
/*        {
          title: 'Utilisateurs',
          bullet: 'dot',
          page: '/dispatcher/user',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/user/new'
            },
            {
              title: 'Liste',
              page: '/dispatcher/user/list'
            },
          ]},*/
        {
          title: 'Chauffeurs',
          bullet: 'dot',
          page: '/dispatcher/driver',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/driver/new'
            },
            {
              title: 'Liste',
              page: '/dispatcher/driver/list'
            },
          ]},
        {
          title: 'Camions',
          bullet: 'dot',
          page: '/dispatcher/truck',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/truck/new'
            },
            {
              title: 'liste',
              page: '/dispatcher/truck/list'
            },
          ]},
        {
          title: 'Citerne',
          bullet: 'dot',
          page: '/dispatcher/tank',
          submenu: [
            {
              title: 'Nouvelle',
              page: '/dispatcher/tank/new'
            },
            {
              title: 'Liste',
              page: '/dispatcher/tank/list'
            },
          ]},
        {
          title: 'Chargement',
          bullet: 'dot',
          page: '/dispatcher/travel-load',
          submenu: [
            {
              title: 'Nouveau',
              page: '/dispatcher/travel-load/new'
            },
            {
              title: 'Liste',
              page: '/dispatcher/travel-load/list'
            },
          ]},
      ]
    },
