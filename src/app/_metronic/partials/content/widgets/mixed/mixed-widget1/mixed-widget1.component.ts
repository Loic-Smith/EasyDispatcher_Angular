...
export class MixedWidget1Component implements OnInit {
  ...
  displayCommads(){
    this.route.navigateByUrl('/dispatcher/command/list');
  }
  displayClients(){
    this.route.navigateByUrl('/dispatcher/client/list');
  }
  displayProduits(){
    this.route.navigateByUrl('/dispatcher/product/list');
  }
  displayUtilisateurs(){
    this.route.navigateByUrl('/dispatcher/user/list');
  }
  displayChauffeurs(){
    this.route.navigateByUrl('/dispatcher/driver/list');
  }
}
