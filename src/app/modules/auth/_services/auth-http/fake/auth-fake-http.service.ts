  ...
  login(email: string, password: string): Observable<any> {
    ...
    return this.getAllUsers().pipe(
      map((result: UserModel[]) => {
        ...
        this.user.accessToken = 'access-token-8f3ae836da744329a6f93bf20594b5cc',
            this.user.refreshToken = 'access-token-f8c137a2c98743f48b643e71161d90aa',
            this.user.roles =  [1] ; // Administrator
        ...
        auth.accessToken = this.user.accessToken;
        auth.refreshToken = this.user.refreshToken;
