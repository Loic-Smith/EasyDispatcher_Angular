...
export class AccountInformationComponent implements OnInit, OnDestroy {
  ...
  loadForm() {
    this.formGroup = this.fb.group({
      username: [this.user.userFirstName, Validators.required],
      email: [this.user.userEmail, Validators.compose([Validators.required, Validators.email])],
  ...
  save() {
    ...
    this.user = Object.assign(this.user, {
      userFirstName: formValues.username,
